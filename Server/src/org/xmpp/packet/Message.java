...
public class Message extends Packet {
    ...
    public enum Type {
        ...
        /** 
         * Request to join a Multi User Chat room. The name of the room is in the body of the message.
         */        
        joinSessionRequest,

        /**
         * Response for joining a MUC room. The body contains an error message or successfully joined
         */        
        joinSessionResponse,
        
        /** 
         * Request to create a Multi User Chat room. The name of the room is in the body of the message.
         */        
        ...
        /**
         * Request the sessions list of a user. The user id is in the body.
         */        
        requestSessionsList,

        /**
         * Response containing the list associated to a user - the list elements are separated by &%
         */        
        responseSessionsList,
        
        /**
         * The body contains the session id.
         */        
        requestCreateElement,
        /**
         * the body contains the element id.
         */        
